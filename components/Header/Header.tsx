...
export default function Header() {
    return <div className="flex flex-col pt-8 gap-y-8 items-center justify-center min-h-[20rem]">
        <div className="w-[27.5rem] h-[5.5rem] relative">
            <Image src={'/assets/logo.svg'} className="z-0" alt="Idealist.az Logo" fill />
        </div>
        <div>
            <Search
