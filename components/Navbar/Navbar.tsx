...
export default function Navbar() {
  ...
  return (
    <nav className="h-[75px] grid grid-cols-[1fr,275px,1fr] w-full relative">
      <div
      ...
      <div></div>
      <div
        className="absolute left-1/2 -translate-x-1/2 top-0 w-[276px] h-[75px] z-30"
        style={{ clipPath: "inset(-2px -2px -2px 0px)" }}
      >
      ...
      <div
        className="bg-white flex justify-end items-center pr-16 z-20"
        style={{ boxShadow: shadow }}
      >
        <Right />
      </div>
