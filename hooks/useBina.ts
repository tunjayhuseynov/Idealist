...
import { BinaRentPropertyTypeOptions, Communal, BinaRentNotAllowed, BinaRentPros, NearbyLocationNames } from "types/category/consts/Bina";
...
export function useBina({ selectedBina }: IProps) {
    ...
    const onFinish: ICreateFormProps<IGenericBinaType>['onFinish'] = async (values, cities, images, postId, coordinates) => {
        try {
            ...
            if (selectedBina.tikili && !values.tikili) throw Error("Tikili məlumatları yoxdur")
            if (selectedBina.torpaq && !values.land) throw Error("Torpaq məlumatları yoxdur")
            ...
            let newDocument: IBina = {
                ...
                tikili: (selectedBina.tikili && values.tikili) ? {
                    ...
                    rentalStatus: values.tikili.rentalStatus ? {
                        ...
                        rentProps: {
                            centralHeatingSystem: values.tikili.rentalStatus.rentalPros.includes("centralHeatingSystem"),
                            cabelTv: values.tikili.rentalStatus.rentalPros.includes("cabelTv"),
                            combi: values.tikili.rentalStatus.rentalPros.includes("combi"),
                            balcony: values.tikili.rentalStatus.rentalPros.includes("balcony"),
                            internet: values.tikili.rentalStatus.rentalPros.includes("internet"),
                            garage: values.tikili.rentalStatus.rentalPros.includes("garage"),
                            pool: values.tikili.rentalStatus.rentalPros.includes("pool"),
                            lift: values.tikili.rentalStatus.rentalPros.includes("lift"),
                            airConditioner: values.tikili.rentalStatus.rentalPros.includes("airConditioner"),
                            kitchen: values.tikili.rentalStatus.rentalPros.includes("kitchen"),
                            washer: values.tikili.rentalStatus.rentalPros.includes("washer"),
                            parkingArea: values.tikili.rentalStatus.rentalPros.includes("parkingArea"),
                            pvcWindow: values.tikili.rentalStatus.rentalPros.includes("pvcWindow"),
                            dishes: values.tikili.rentalStatus.rentalPros.includes("dishes"),
                            refrigerator: values.tikili.rentalStatus.rentalPros.includes("refrigerator"),
                            telephone: values.tikili.rentalStatus.rentalPros.includes("telephone"),
                            tv: values.tikili.rentalStatus.rentalPros.includes("tv"),
                        }
